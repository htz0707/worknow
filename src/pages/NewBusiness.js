...
import '../assets/styles/NewBusiness.scss'
          ...
          <div className='container-md'>
            <div className='row'>
              ...
              <div className='col-lg-7'>
                <img src={TwoPeople} className='image' />
              </div>
            </div>
          </div>
        </section>
      ...
      <div className='container-md'>
        <div className='row'>
          <div className='col-lg-3'>
            ...
            <p>Tối ưu hóa hiệu suất công việc bằng cách khám phá không gian/môi trường tươi mới và sáng tạo cùng Worknow.</p>
          </div>
          <div className='col-lg-3'>
            ...
            <p>Không gian làm việc chung, Cao ốc văn phòng, Trung tâm mua sắm, Quán cà phê, Khách sạn,...</p>
          </div>
          <div className='col-lg-3'>
            ...
            <p>Giải pháp làm việc từ xa hoặc trực tiếp cho bất kỳ doanh nghiệp ở mọi lĩnh vực kinh doanh.</p>
          </div>
          <div className='col-lg-3'>
            ...
            <p>Chi phí phải chăng và phù hợp, bạn sẽ chỉ thanh toán cho những tiện ích mà mình sử dụng.</p>
          </div>
        </div>
      </div>
      <div className='container-md'>
        <h3 className='my-5'>LOẠI HÌNH NỔI BẬT</h3>
        <div className='hl-containter'>
          <div className='flex'>
            <div className='image-card image-1'>
              ...
              <Button className='btn-bottom rounded-pill' variant='secondary'>Khám Phá {' '} <BiPaperPlane className='mx-2' /></Button>
              <img src={hl4} alt='hl-4' className='image-hl' />
            </div>
            ...
            <div className='image-card image-2'>
              ...
              <Button className='btn-bottom rounded-pill' variant='secondary'>Khám Phá {' '} <BiPaperPlane className='mx-2' /></Button>
              <img src={hl2} alt='hl-2' className='image-hl' />
            </div>
          </div>
          <div className='flex'>
            <div className='image-card image-3'>
              ...
              <Button className='btn-bottom rounded-pill' variant='secondary'>Khám Phá {' '} <BiPaperPlane className='mx-2' /></Button>
              <img src={hl1} alt='hl-1' className='image-hl' />
            </div>

            <div className='image-card image-4'>
              ...
              <Button className='btn-bottom rounded-pill' variant='secondary'>Khám Phá {' '} <BiPaperPlane className='mx-2' /></Button>
              <img src={hl3} alt='hl-3' className='image-hl' />
            </div>
          </div>
        </div>
        <h3 className='mb-5'>ĐỐI TÁC CỦA CHÚNG TÔI</h3>
        <div className='mb-5'>
          <div className='mb-5'>
            ...
            <img src={P5} alt='p1' className='image-partner' />
          </div>
          <div className='mt-5'>
            <img src={P1} alt='p1' className='image-partner' />
            <img src={P2} alt='P2' className='image-partner' />
