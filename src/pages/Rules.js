    ...
    <div className='rules'>
      <div className='rules-layout'>
        <h3 className='fw-bold'>
          Điều kiện & Điều khoản sử dụng website
        </h3>
        <p>
          Các Điều kiện và Điều khoản Sử dụng website này (“Điều khoản Sử dụng”)
          áp dụng cho trang web của chúng tôi tại <a href='www.worknow.center'>www.worknow.center</a>, và tất cả
          các trang liên kết với <a href='www.worknow.center'>www.worknow.center</a>, các công ty con và chi
          nhánh (gọi chung là “Trang web”). Trang web là tài sản của Công ty
          TNHH Rockship. Sử dụng Trang web đồng nghĩa với việc bạn đồng ý với
          các điều khoản sử dụng này; nếu bạn không đồng ý, xin vui lòng không
          sử dụng trang web.
        </p>
        <p>
          Chúng tôi có toàn quyền quyết định thay đổi, sửa đổi, thêm và / hoặc xóa
          các phần của Điều khoản sử dụng này bất kỳ lúc nào. Bạn có trách nhiệm
          kiểm tra các Điều khoản Sử dụng này định kỳ để cập nhật về các thay đổi.
          Việc bạn tiếp tục sử dụng Trang web sau khi các thay đổi được đăng có
          nghĩa là bạn chấp nhận và đồng ý với các thay đổi đó. Miễn là bạn tuân
          thủ các Điều khoản sử dụng này, chúng tôi cấp cho bạn đặc quyền cá nhân,
          không độc quyền, không thể chuyển nhượng, hạn chế để truy cập và sử dụng
          Trang web.
        </p>
        <h5 className='fw-bold'>I. Nội dung</h5>
        <p>
          Tất cả văn bản, đồ họa, giao diện người dùng, giao diện trực quan, hình ảnh, nhãn hiệu, biểu trưng, âm thanh, âm nhạc, ảnh nghệ thuật và mã máy tính (gọi chung là “Nội dung”), bao gồm nhưng không giới hạn trong thiết kế, cấu trúc, lựa chọn, phối hợp, biểu hiện. xem và cảm nhận” và sắp xếp Nội dung như vậy, có trên Trang web được sở hữu, kiểm soát hoặc cấp phép bởi Công ty TNHH Rockship và được bảo vệ bởi trang phục thương mại, quyền sao chép, luật sáng chế và nhãn hiệu và các quyền sở hữu trí tuệ khác và luật cạnh tranh không lành mạnh.
        </p>
        <p>
        ...
        <p>
          Bạn có thể đăng ký một tài khoản trên Trang web (một "Tài khoản") hoặc thông tin
          đăng nhập trên các phương tiện truyền thông xã hội khác. Để sử dụng các phần nhất
          định của Trang web, bạn không bắt buộc phải đăng ký Tài khoản. Tuy nhiên, một số
          tính năng nhất định của Trang web, chẳng hạn như truy cập vào lịch sử đặt hàng của
          bạn, yêu cầu bạn phải đăng ký một Tài khoản. Bạn phải cung cấp thông tin chính xác
          và đầy đủ và cập nhật thông tin tài khoản của bạn. Bạn không được:
          <br /> <b>(i)</b>&nbsp;&nbsp; Chọn hoặc sử dụng làm tên người dùng là tên của người khác với mục đích mạo danh người đó;
          <br /> <b>(ii)</b>&nbsp; Sử dụng một tên người dung là tên bất kỳ quyền nào của một người khác ngoài bạn mà không có sự cho phép thích hợp;
          <br /> <b>(iii)</b> Sử dụng một tên người dùng là tên khác xúc phạm, khiếm nhã hoặc tục tĩu.
          <br />Bạn tự chịu trách nhiệm về hoạt động xảy ra trên Tài khoản của mình và bảo mật mật khẩu tài khoản của bạn. Bạn không được sử dụng Tài khoản hoặc thông tin đăng ký của người khác cho Trang web mà không được phép. Bạn phải thông báo cho chúng tôi ngay lập tức bất kỳ thay đổi nào về tính hợp lệ khi sử dụng Trang web, vi phạm bảo mật hoặc việc sử dụng trái phép Tài khoản của bạn. Bạn không nên công bố, phân phối hoặc đăng thông tin đăng nhập Tài khoản của mình. Bạn có thể xóa Tài khoản của mình bất kỳ lúc nào, như được mô tả trong Chính sách bảo mật của chúng tôi.
        </p>
        ...
        <p>
          Bạn đồng ý không thăm dò, quét hoặc kiểm tra lỗ hổng của Trang web hoặc bất kỳ mạng nào được kết nối với Trang web hoặc vi phạm các biện pháp bảo mật hoặc xác thực trên Trang web hoặc bất kỳ mạng nào được kết nối với Trang web. Bạn sẽ không đảo ngược tra cứu, theo dõi hoặc tìm cách theo dõi bất kỳ thông tin nào về bất kỳ người dùng hoặc khách hang truy cập vào Trang web hoặc bất kỳ khách hàng nào khác của Công ty TNHH Rockship, bao gồm bất kỳ tài khoản nào của chúng tôi không thuộc sở hữu của bạn, nguồn hoặc khai thác Trang web hoặc bất kỳ dịch vụ hoặc thông tin nào có sẵn hoặc được cung cấp bởi hoặc thông qua Trang web, theo bất kỳ mục đích nào để tiết lộ bất kỳ thông tin nào, bao gồm nhưng không giới hạn đối với nhận dạng cá nhân hoặc thông tin, ngoài thông tin của riêng bạn, theo quy định của Trang web.
        </p>
        <p>
          Bạn đồng ý không:
          <br /><b>(a)</b> Thực hiện bất kỳ hành động nào áp đặt tải lớn không hợp lý hoặc không cân xứng trên cơ sở hạ tầng của trang web hoặc hệ thống hoặc mạng của WorkNow hoặc bất kỳ hệ thống hoặc mạng nào được kết nối với Trang web hoặc Công ty TNHH Rockship;
          <br /><b>(b)</b> Sử dụng bất kỳ thiết bị, phần mềm hoặc thường trình nào để can thiệp hoặc cố can thiệp vào hoạt động đúng đắn của Trang web hoặc bất kỳ giao dịch nào đang được thực hiện trên Trang web;
          <br /><b>(c)</b> Cố gắng giải mã, dịch ngược, tháo rời hoặc thiết kế đối chiếu bất kỳ phần mềm nào bao gồm hoặc tạo lập Trang web;
          <br /><b>(d)</b> Giả mạo tiêu đề hoặc bằng cách khác điều khiển mã định danh để che giấu nguồn gốc của bất kỳ thư hoặc thông điệp nào bạn gửi cho chúng tôi trên hoặc thông qua Trang web. Bạn không được giả vờ rằng bạn là người mà bạn đại diện, người khác hoặc mạo danh bất kỳ cá nhân hoặc tổ chức nào khác;
          <br /><b>(e)</b> Xóa hoặc thay đổi bất kỳ tài liệu nào mà chúng tôi hoặc bất kỳ cá nhân hoặc tổ chức nào khác đăng trên trang web;
          <br /><b>(f)</b> Sử dụng Trang web hoặc bất kỳ Nội dung nào cho bất kỳ mục đích trái pháp luật hoặc bị cấm nào theo Điều khoản Sử dụng hoặc để thu hút hiệu suất của bất kỳ hoạt động bất hợp pháp hay vi phạm quyền của Công ty TNHH Rockship;
          <br /><b>(get)</b> Có bất kỳ hành động nào vi phạm Điều khoản Sử dụng của chúng tôi.
        </p>
        ...
        <p>
          ...
          <br /><b>(a)</b> Tuân thủ quy trình pháp lý, luật hiện hành hoặc yêu cầu của chính phủ;
          <br /><b>(b)</b> Thi hành Hiệp định này;
          <br /><b>(c)</b> Trả lời các khiếu nại rằng bất kỳ Nội dung Người dùng nào vi phạm quyền của bên thứ ba;
          <br /><b>(d)</b> Bảo vệ quyền, tài sản hoặc an toàn cá nhân của WorkNow, người dùng của chúng tôi và công chúng.
          <br />Bạn hiểu rằng việc xử lý kỹ thuật và truyền tải Trang web, bao gồm Nội dung Người dùng của bạn, có thể bao gồm
          <br /><b>(i)</b>&nbsp; Việc truyền tải qua các mạng khác nhau;
          <br /><b>(ii)</b> Các thay đổi phù hợp và thích nghi với các yêu cầu kỹ thuật của các mạng hoặc thiết bị kết nối.
        </p>
        <h5 className='fw-bold'>
          VII. Thanh toán; Đặt hàng & Tính khả dụng; Dịch vụ thanh toán và đăng ký liên tục
        </h5>
        <p>
          Bạn đồng ý cung cấp thông tin thanh toán chính xác và cập nhật tại thời điểm bạn đặt hàng bất kỳ Sản phẩm nào. Chúng tôi đã ký hợp đồng với một bộ xử lý thanh toán của bên thứ ba để tạo thuận lợi cho việc mua hàng được thực hiện trên Trang web. Khi bạn mua hàng qua Trang web, bạn sẽ cung cấp chi tiết thanh toán của mình và mọi thông tin bổ sung cần thiết để hoàn tất đơn đặt hàng trực tiếp cho bộ xử lý thanh toán của bên thứ ba của chúng tôi. Bạn nên biết rằng các giao dịch thanh toán trực tuyến phải được kiểm tra xác nhận bởi người xử lý thanh toán và nhà phát hành thẻ của bạn và chúng tôi không chịu trách nhiệm nếu nhà phát hành thẻ của bạn từ chối cấp phép thanh toán vì bất kỳ lý do gì. Để bảo vệ bạn, bộ xử lý thanh toán của chúng tôi sử dụng các giao thức ngăn chặn gian lận khác nhau và hệ thống xác minh tiêu chuẩn ngành để giảm gian lận và bạn cho phép nó xác minh và xác thực thông tin thanh toán của bạn. Xin lưu ý, nhà phát hành thẻ của bạn có thể tính phí xử lý trực tuyến hoặc phí xử lý. Chúng tôi không chịu trách nhiệm cho việc này. Ở một số khu vực pháp lý, bộ phận xử lý thanh toán của chúng tôi có thể sử dụng các bên thứ ba theo các yêu cầu bảo mật và bảo mật dữ liệu nghiêm ngặt cho mục đích của các dịch vụ xử lý thanh toán.
        </p>
        <p>
          Trừ khi có quy định khác, giá được trích dẫn không bao gồm: (a) chi phí vận chuyển hoặc vận chuyển đến địa điểm giao hàng đã thỏa thuận; và (b) thuế giá trị gia tăng và bất kỳ thuế hoặc nghĩa vụ nào khác (nếu có) phải được cộng vào giá phải trả. Bạn đồng ý thanh toán thuế, vận chuyển hoặc vận chuyển Sản phẩm vì các chi phí đó được chúng tôi chỉ định khi bạn gửi đơn đặt hàng của mình.
        </p>
        <p>
          Một số Dịch vụ mà chúng tôi cung cấp, chẳng hạn như dịch vụ không bao giờ hết hạn, có thể bao gồm một khoảng thời gian ban đầu trả phí một lần, sau đó là các khoản phí định kỳ theo thỏa thuận của bạn. Bạn có thể lựa chọn đặt hàng định kỳ bất kỳ sản phẩm nào. <b>KHI BẠN LỰA CHỌN THANH TOÁN ĐỊNH KỲ, NGHĨA LÀ BẠN CÔNG NHẬN VÀ ĐỒNG Ý RẰNG (A) WORKNOW (HOẶC ĐƠN VỊ XỬ LÝ THANH TOÁN THỨ 3 CỦA CHÚNG TÔI) ĐƯỢC ỦY QUYỀN TÍNH PHÍ ĐỊNH KỲ (VÍ DỤ: HÀNG THÁNG) MIỄN LÀ BẠN CÒN THAM GIA VÀ (B) ĐĂNG KÝ THAM GIA CỦA BẠN SẼ TIẾP TỤC ĐẾN KHI BẠN HỦY BỎ HOẶC CHÚNG TÔI TẠM NGƯNG HAY NGƯNG CUNG CẤP QUYỀN TRUY CẬP TRANG WEB HOẶC SẢN PHẨM. BẠN CÓ THỂ HỦY ĐĂNG KÝ THAM GIA BẰNG CÁCH GỬI EMAIL ĐẾN WORKNOWCENTER@GMAIL.COM. BẠN SẼ CHỊU TRÁCH NHIỆM CHO TẤT CẢ CÁC CHI PHÍ PHÁT SINH CHO CÁC ĐƠN ĐẶT HÀNG ĐÃ ĐƯỢC XỬ LÝ TRƯỚC ĐÓ.</b> Tất cả các khoản thanh toán định kỳ đều được hoàn toàn kiếm được khi thanh toán.
        </p>
        <p>
          Chúng tôi cố gắng mô tả chính xác Sản phẩm. Tuy nhiên, chúng tôi không đảm bảo rằng các mô tả đó là chính xác, đầy đủ, đáng tin cậy, hiện tại hoặc không có lỗi. Nếu một Sản phẩm không giống như mô tả, biện pháp khắc phục duy nhất của bạn là hủy đơn đặt, trừ khi có quy định khác bằng văn bản của chúng tôi. Thỉnh thoảng chúng tôi chạy chương trình khuyến mãi hoặc cung cấp ưu đãi có giới hạn thời gian cho Sản phẩm của chúng tôi. Vui lòng xem lại khuyến mại hoặc phiếu mua hàng để đủ điều kiện và các điều khoản và điều kiện khác.
        </p>
        <h5 className='fw-bold'>VIII. Hủy đơn hàng</h5>
        <p>
          Chúng tôi chấp nhận yêu cầu hủy đến của bạn quy định tại "Chính sách giao hủy đặt chỗ và hoàn tiền". Để hủy đơn đặt, vui lòng gửi email cho chúng tôi theo địa chỉ <i>worknowcenter@gmail.com</i> với tên, địa chỉ, số đơn đặt hàng và (các) Sản phẩm bạn muốn trao đổi. Sau khi chúng tôi nhận được yêu cầu bằng văn bản của bạn, chúng tôi sẽ trả lời với các hướng dẫn thêm về việc hủy đơn đặt với chúng tôi. Chúng tôi sẽ xử lý thay thế hoặc hoàn tiền cho bạn trong thời gian sớm nhất có thể.
        </p>
        <h5 className='fw-bold'>IX. Giới hạn trách nhiệm pháp lý và từ chối bảo hành</h5>
        <p>
          Các bên WorkNow không đảm bảo rằng trang web sẽ hoạt động không có lỗi hoặc trang web, máy chủ của nó hoặc nội dung không có vi-rút máy tính hoặc các tính năng gây ô nhiễm hoặc phá hoại tương tự. Nếu việc bạn sử dụng trang web hoặc nội dung dẫn đến nhu cầu phục vụ hoặc thay thế thiết bị hoặc dữ liệu thì không bên nào WorkNow chịu trách nhiệm về các chi phí đó.
        </p>
        <p>
          Trừ khi được cung cấp bởi chúng tôi bằng văn bản, nội dung và các dịch vụ được cung cấp trên cơ sở “nguyên trạng” và “có sẵn” mà không có bất kỳ sự bảo đảm nào. Các bên WorkNow từ chối mọi bảo đảm, bao gồm, nhưng không giới hạn, các bảo đảm về tiêu đề, khả năng bán hàng, không vi phạm quyền của bên thứ ba và phù hợp cho mục đích cụ thể.
        </p>
        <p>
          Trong mọi trường hợp, mọi bên WorkNow đều không chịu trách nhiệm cho bất kỳ thiệt hại nào (bao gồm, không giới hạn, thiệt hại ngẫu nhiên và hậu quả, mất lợi nhuận hoặc thiệt hại do mất dữ liệu hoặc gián đoạn kinh doanh) do việc sử dụng hoặc không có khả năng sử dụng dịch vụ hoặc nội dung , dù dựa trên bảo hành, hợp đồng, hành vi (kể cả sơ suất), hay bất kỳ lý thuyết pháp lý nào khác, ngay cả khi bên WorkNow đã được thông báo về khả năng thiệt hại đó, hoặc cho bất kỳ thiệt hại trực tiếp nào.
        </p>
        <p>
          Một số khu vực pháp lý không cho phép loại trừ bảo đảm ngụ ý hoặc giới hạn trách nhiệm đối với các thiệt hại ngẫu nhiên hoặc do hậu quả, do đó các giới hạn hoặc loại trừ trên có thể không áp dụng cho bạn. Trong các khu vực pháp lý như vậy, trách nhiệm pháp lý của các bên WorkNow sẽ bị giới hạn trong phạm vi tối đa được pháp luật cho phép. Không có điều khoản nào trong các điều khoản này ảnh hưởng đến bất kỳ quyền và biện pháp pháp lý nào mà bạn có theo luật pháp địa phương.
        </p>
        <h5 className='fw-bold'>
          X. Sự bồi thường
        </h5>
        <p>
          Trong phạm vi tối đa được luật pháp hiện hành cho phép, bạn đồng ý bảo vệ, bồi thường và giữ vô hại cho các bên WorkNow khỏi và chống lại bất kỳ khiếu nại, hành động hoặc yêu cầu nào, bao gồm, không giới hạn, chi phí pháp lý và kế toán phù hợp, phát sinh hoặc do vi phạm của bạn về Thỏa thuận này, mọi Nội dung hoặc phản hồi của người dùng mà bạn cung cấp hoặc quyền truy cập của bạn, sử dụng hoặc lạm dụng Nội dung hoặc Dịch vụ. Chúng tôi sẽ thông báo cho bạn về bất kỳ khiếu nại, kiện tụng hoặc thủ tục tố tụng nào dẫn đến nghĩa vụ bồi thường này, và bạn đồng ý làm như vậy bằng cách viết thư cho Phòng Pháp lý WorkNow theo địa chỉ <i>worknowcenter@gmail.com</i>. Chúng tôi bảo lưu quyền đảm nhận sự bảo vệ và kiểm soát độc quyền đối với bất kỳ vấn đề nào có thể được bồi thường theo phần này. Trong trường hợp này, bạn đồng ý hợp tác với bất kỳ yêu cầu hợp lý nào giúp chúng tôi bảo vệ vấn đề đó.
        </p>
        <h5 className='fw-bold'>
          XI. Giải quyết tranh chấp
        </h5>
        <p>
          <b>BẤT KỲ TRANH CHẤP NÀO PHÁT SINH HAY LIÊN QUAN ĐẾN ĐIỀU KHOẢN SỬ DỤNG SẼ ĐƯỢC GIẢI QUYẾT DUY NHẤT BẰNG KIỆN TỤNG CÁ NH N, VÀ SẼ KHÔNG ĐƯA ĐẾN BẤT KỲ VỤ PH N XỬ, KIỆN TỤNG TẬP THỂ HAY CÁC THỦ TỤC ĐẠI DIỆN KHÁC.</b>
        </p>
        <p>
          Ngoại trừ các tranh chấp về khiếu nại nhỏ mà bạn hoặc WorkNow tìm cách đưa kiện tụng cá nhân vào tòa án địa phương nơi địa chỉ thanh toán của bạn được gửi tới hoặc tranh chấp mà bạn hoặc WorkNow yêu cầu trợ giúp bắt buộc hoặc công bằng cho việc sử dụng bất hợp pháp sở hữu trí tuệ, bạn và WorkNow từ bỏ quyền của bạn đối với phiên tòa xét xử và bất kỳ tranh chấp nào phát sinh từ hoặc liên quan đến Thỏa thuận này hoặc Dịch vụ của chúng tôi được giải quyết tại tòa án. Thay vào đó, đối với bất kỳ tranh chấp hoặc khiếu nại nào mà bạn có đối với WorkNow hoặc liên quan đến bất kỳ phương diện nào với Dịch vụ, bạn đồng ý liên hệ trước với WorkNow và cố gắng giải quyết khiếu nại một cách không chính thức bằng cách gửi thông báo bằng văn bản về khiếu nại của bạn (“Thông báo”) cho WorkNow tại worknowcenter@gmail.com hoặc bằng thư xác nhận gửi đến Bộ phận pháp lý WorkNow. Thông báo phải (a) bao gồm tên, địa chỉ cư trú, địa chỉ email và số điện thoại của bạn; (b) mô tả bản chất và cơ sở của yêu cầu; và (c) đề xuất các biện pháp giải quyết cụ thể. Thông báo của chúng tôi cho bạn sẽ có dạng tương tự như được mô tả ở trên.
        </p>
        <p>
          Trọng tài viên, WorkNow, và bạn sẽ duy trì tính bảo mật của bất kỳ thủ tục tố tụng, bản án và phán quyết nào, bao gồm, nhưng không giới hạn, tất cả các thông tin thu thập, chuẩn bị và trình bày cho các mục đích tố tụng hoặc liên quan đến (các) tranh chấp trong đó. Trọng tài sẽ có thẩm quyền đưa ra các phán quyết thích hợp để bảo vệ tính bảo mật, trừ khi luật pháp quy định ngược lại. Nhiệm vụ bảo mật không áp dụng trong phạm vi rằng công bố thông tin là cần thiết để chuẩn bị hoặc tiến hành phiên điều trần tố tụng dựa trên cáo trạng, liên quan đến đơn xin xét xử sơ bộ hoặc liên quan phản đối tư pháp đối với phán quyết trọng tài hay thi hành án hoặc trong phạm vi tiết lộ được yêu cầu theo luật hoặc quyết định của tòa án.
        </p>
        <p>
          Bất kỳ khiếu nại nào phát sinh hoặc liên quan đến Thỏa thuận này hoặc Dịch vụ của chúng tôi phải được nộp trong vòng một năm sau khi khiếu nại đó được phát sinh; nếu không, yêu cầu bị cấm vĩnh viễn, có nghĩa là bạn và WorkNow sẽ không có quyền xác nhận khiếu nại. Bạn có quyền từ chối phân xử ràng buộc trong vòng 30 ngày kể từ ngày bạn chấp nhận các điều khoản của quy định này bằng cách gửi email tới worknowcenter@gmail.com. Để có hiệu lực, thông báo chọn không tham gia phải bao gồm tên đầy đủ và địa chỉ của bạn và chỉ rõ mục đích của bạn là không tham gia vào tranh chấp ràng buộc. Bằng cách chọn không tham gia phân xử ràng buộc, bạn đồng ý giải quyết tranh chấp theo Điều khoản sử dụng này.
        </p>
        <p>
          Nếu bất kỳ phần nào của quy định này được phát hiện là không thể thi hành hoặc bất hợp pháp vì bất kỳ lý do nào,
          <br /><b>(a)</b> Điều khoản không thể thực thi hoặc trái pháp luật sẽ bị cắt đứt khỏi Thỏa thuận này;
          <br /><b>(b)</b> Sự cắt giảm điều khoản không thể thi hành hoặc bất hợp pháp sẽ không có tác động đến phần còn lại của quy định này hoặc khả năng của các bên để buộc phân xử của bất kỳ khiếu nại còn lại nào trên cơ sở cá nhân theo quy định này;
          <br /><b>(c)</b> Trong phạm vi mà bất kỳ khiếu nại nào phải tiến hành trên cơ sở nhóm, tập thể, hợp nhất hoặc đại diện, những khiếu nại đó phải được khởi kiện tại tòa án dân sự có thẩm quyền và không phải trong các phiên phân xử, và các bên đồng ý rằng kiện tụng sẽ làm trì hoãn kết quả của bất kỳ khiếu nại cá nhân trong cuộc phân xử. Hơn nữa, nếu bất kỳ phần nào của quy định này được phát hiện là cấm một yêu cầu cá nhân tìm kiếm sự giúp đỡ từ cộng đồng, thì điều khoản đó sẽ không có hiệu lực trong phạm vi việc giúp đỡ được phép tìm kiếm ngoài phiên phân xử, và phần còn lại của quy định này sẽ là có hiệu lực.
        </p>
        <h5 className='fw-bold'>
          XII. Chấm dứt
        </h5>
        ...
        <p>
          Công Ty Cổ phần TNHH Rockship là công ty có trụ sở chính tại số 61K Võ Oanh, Phường Phường 25, Quận Bình Thạnh, Thành phố Hồ Chí Minh, Việt Nam. Bạn có thể Liên hệ với chúng tôi theo địa chỉ văn phòng của chúng tôi hoặc theo địa chỉ email sau: <i>worknowcenter@gmail.com</i> hoặc hotline: (+84) 28 3620 5144.
        </p>
      </div>
    </div>
  );
